...
Disclaimer: To make easier to follow up this reading I used just one image on this readme file, however, you can find all step_by_step process images on the folder **step_by_step_images**. Also output images for this project can be found in folder **test_images_output** and output videos in folder **test_videos_output**. 
